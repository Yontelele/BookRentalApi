...
namespace Labb2.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public async Task<ActionResult<Book>> PostBook(Book book)
        {
            ...
            foreach (var authorId in book.Author.Select(a => a.Id))
            {
                Author existingAuthor = await _context.Author.FindAsync(authorId);
            ...
            // Koppla existerande författare till boken
            book.Author = existingAuthors;
